...
String Language =
    "EN";  // NOTE: Only the weather description is translated by OWM
           // Examples: Arabic (AR) Czech (CZ) English (EN) Greek (EL) Persian(Farsi) (FA) Galician
           // (GL) Hungarian (HU) Japanese (JA) Korean (KR) Latvian (LA) Lithuanian (LT) Macedonian
           // (MK) Slovak (SK) Slovenian (SL) Vietnamese (VI)
...
int daylightOffset_sec =
    3600;  // In the UK DST is +1hr or 3600-secs, other countries may use 2hrs 7200 or 30-mins 1800
           // or 5.5hrs 19800 Ahead of GMT use + offset behind - offset
