...
* 
* Only use this function when ever you have finished drawing to the screen but still need the touch enabled.
* This workaround may still leave power some other stray power leaks due to the hardware design and as such may cause other problems such as grey screen.
