...
FRAME_TIMES_WHITE_TO_GL16 = {
    ...
    "ED133UT2": [6.0, 6.0, 4.0, 4.0, 6.0, 6.0, 6.0, 8.0, 8.0, 10.0, 10.0, 10.0, 20.0, 20.0, 30.0],
}
...
FRAME_TIMES_BLACK_TO_GL16 = {
    ...
    "ED060SC4": [1.0, 1.0, .8, .8, .8, .8, .8, 1.0, 1.0, 1.5, 1.5, 2.0, 2.0, 10.0, 30.0],
    "ED047TC1": [1.0, 1.0, .8, .8, .8, .8, .8, 1.0, 1.0, 1.5, 1.5, 2.0, 2.0, 10.0, 30.0],
    "ED097TC2": [.7, .8, .8, .6, .6, .6, .6, .6, .6, .6, .6, .8, .8, 5.0, 15.0],
    "ED133UT2": [5.0, 3.0, 3.0, 3.0, 3.0, 3.0, 3.0, 3.0, 3.0, 3.0, 5.0, 5.0, 5.0, 10.0, 20.0]
}
